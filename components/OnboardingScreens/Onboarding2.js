  ...
  return (
    <div className={styles.main_div_obs1}>
        ...
        <div className={styles.circle_main_div}>
            ...
            <div className={styles.circle}> <FiCircle style={{fontSize:20}} onClick={()=>  navigate("/Onboarding3")} /> </div>

        </div>

        <div className={styles.btns_main_div}>
            <button className={styles.btns} id="skip_btn">Skip</button>

           <Link to="/Onboarding3"> 
            <button className={styles.btns} id="next_btn">Next</button>
           </Link>
        </div>
